...
use travego;
create table Passenger (Passenger_id int primary key, Passenger_name varchar(20), Category varchar(20), Gender varchar(20), Boarding_city varchar(20), Destination_city varchar(20),
...
(7,'Hemant', 'Non-AC', 'M', 'Panaji', 'Mumbai', 700, 'Slepper'),
